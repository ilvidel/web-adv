...
lftp -c "set ftp:passive-mode true; set ssl:verify-certificate false; open ftp://$FTP_USER:$FTP_PASS@$FTP_HOST:21; mirror --parallel=10 -Rv --only-missing --ignore-time public/ /www.advmiguelturra.org/; quit;"
